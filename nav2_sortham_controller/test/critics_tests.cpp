...
#include "nav2_sortham_controller/critics/constraint_critic.hpp"
#include "nav2_sortham_controller/critics/goal_angle_critic.hpp"
#include "nav2_sortham_controller/critics/goal_critic.hpp"
#include "nav2_sortham_controller/critics/obstacles_critic.hpp"
#include "nav2_sortham_controller/critics/cost_critic.hpp"
#include "nav2_sortham_controller/critics/path_align_critic.hpp"
#include "nav2_sortham_controller/critics/path_align_legacy_critic.hpp"
#include "nav2_sortham_controller/critics/path_angle_critic.hpp"
#include "nav2_sortham_controller/critics/path_follow_critic.hpp"
#include "nav2_sortham_controller/critics/prefer_forward_critic.hpp"
#include "nav2_sortham_controller/critics/twirling_critic.hpp"
#include "nav2_sortham_controller/critics/velocity_deadband_critic.hpp"
...
using namespace sortham::critics;  // NOLINT
using namespace sortham::utils;  // NOLINT
...
TEST(CriticTests, ConstraintsCritic)
{
  ...
  critic.on_configure(node, "sortham", "critic", costmap_ros, &param_handler);
