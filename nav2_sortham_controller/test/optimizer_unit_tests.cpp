...
TEST(OptimizerTests, BasicInitializedFunctions)
{
  ...
  node->declare_parameter("sorthamc.batch_size", rclcpp::ParameterValue(1000));
  node->declare_parameter("sorthamc.time_steps", rclcpp::ParameterValue(50));
  ...
  optimizer_tester.initialize(node, "sorthamc", costmap_ros, &param_handler);
...
TEST(OptimizerTests, setOffsetTests)
{
  auto node = std::make_shared<rclcpp_lifecycle::LifecycleNode>("my_node");
  OptimizerTester optimizer_tester;
  node->declare_parameter("sorthamc.model_dt", rclcpp::ParameterValue(0.1));
  node->declare_parameter("controller_frequency", rclcpp::ParameterValue(30.0));
  node->declare_parameter("sorthamc.batch_size", rclcpp::ParameterValue(1000));
  node->declare_parameter("sorthamc.time_steps", rclcpp::ParameterValue(50));
  auto costmap_ros = std::make_shared<nav2_costmap_2d::Costmap2DROS>(
...
TEST(OptimizerTests, FallbackTests)
{
  ...
  node->declare_parameter("sorthamc.batch_size", rclcpp::ParameterValue(1000));
  node->declare_parameter("sorthamc.time_steps", rclcpp::ParameterValue(50));
  node->declare_parameter("sorthamc.retry_attempt_limit", rclcpp::ParameterValue(2));
  auto costmap_ros = std::make_shared<nav2_costmap_2d::Costmap2DROS>(
    "dummy_costmap", "", "dummy_costmap");
  ParametersHandler param_handler(node);
  rclcpp_lifecycle::State lstate;
...
TEST(OptimizerTests, applyControlSequenceConstraintsTests)
{
  ...
  node->declare_parameter("sorthamc.batch_size", rclcpp::ParameterValue(1000));
  node->declare_parameter("sorthamc.time_steps", rclcpp::ParameterValue(50));
  node->declare_parameter("sorthamc.vx_max", rclcpp::ParameterValue(1.0));
  node->declare_parameter("sorthamc.vx_min", rclcpp::ParameterValue(-1.0));
  node->declare_parameter("sorthamc.vy_max", rclcpp::ParameterValue(0.75));
  node->declare_parameter("sorthamc.wz_max", rclcpp::ParameterValue(2.0));
  auto costmap_ros = std::make_shared<nav2_costmap_2d::Costmap2DROS>(
    "dummy_costmap", "", "dummy_costmap");
  ParametersHandler param_handler(node);
  rclcpp_lifecycle::State lstate;
...
TEST(OptimizerTests, updateStateVelocitiesTests)
{
  ...
  node->declare_parameter("sorthamc.vx_max", rclcpp::ParameterValue(1.0));
  node->declare_parameter("sorthamc.vx_min", rclcpp::ParameterValue(-1.0));
  node->declare_parameter("sorthamc.vy_max", rclcpp::ParameterValue(0.60));
  node->declare_parameter("sorthamc.wz_max", rclcpp::ParameterValue(2.0));
  auto costmap_ros = std::make_shared<nav2_costmap_2d::Costmap2DROS>(
    "dummy_costmap", "", "dummy_costmap");
  ParametersHandler param_handler(node);
