...
#ifndef NAV2_SORTHAM_CONTROLLER__TOOLS__UTILS_HPP_
#define NAV2_SORTHAM_CONTROLLER__TOOLS__UTILS_HPP_
...
inline void savitskyGolayFilter(
  ...
  std::array<sortham::models::Control, 4> & control_history,
...
#endif  // NAV2_SORTHAM_CONTROLLER__TOOLS__UTILS_HPP_
