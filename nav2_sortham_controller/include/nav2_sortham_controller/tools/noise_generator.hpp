...
#ifndef NAV2_SORTHAM_CONTROLLER__TOOLS__NOISE_GENERATOR_HPP_
#define NAV2_SORTHAM_CONTROLLER__TOOLS__NOISE_GENERATOR_HPP_
...
public:
  /**
    * @brief Constructor for sortham::NoiseGenerator
    */
   ...
   */
  void initialize(
    sortham::models::OptimizerSettings & settings,
   ...
   * @param is_holonomic If base is holonomic
   */
  void reset(sortham::models::OptimizerSettings & settings, bool is_holonomic);
...
protected:
  ...
  sortham::models::OptimizerSettings settings_;
  bool is_holonomic_;
...
#endif  // NAV2_SORTHAM_CONTROLLER__TOOLS__NOISE_GENERATOR_HPP_
