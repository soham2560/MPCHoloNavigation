...
#ifndef NAV2_SORTHAM_CONTROLLER__TOOLS__PATH_HANDLER_HPP_
#define NAV2_SORTHAM_CONTROLLER__TOOLS__PATH_HANDLER_HPP_
...
public:
  /**
    * @brief Constructor for sortham::PathHandler
    */
  PathHandler() = default;

  /**
    * @brief Destructor for sortham::PathHandler
    */
  ~PathHandler() = default;
...
#endif  // NAV2_SORTHAM_CONTROLLER__TOOLS__PATH_HANDLER_HPP_
