...
#ifndef NAV2_SORTHAM_CONTROLLER__MOTION_MODELS_HPP_
#define NAV2_SORTHAM_CONTROLLER__MOTION_MODELS_HPP_

#include <cstdint>

#include "nav2_sortham_controller/models/control_sequence.hpp"
...
public:
  /**
    * @brief Constructor for sortham::MotionModel
    */
  MotionModel() = default;

  /**
    * @brief Destructor for sortham::MotionModel
    */
...
/**
 * @class sortham::AckermannMotionModel
...
public:
  /**
    * @brief Constructor for sortham::AckermannMotionModel
    */
...
/**
 * @class sortham::DiffDriveMotionModel
...
public:
  /**
    * @brief Constructor for sortham::DiffDriveMotionModel
    */
...
public:
  /**
    * @brief Constructor for sortham::OmniMotionModel
    */
...
#endif  // NAV2_SORTHAM_CONTROLLER__MOTION_MODELS_HPP_
