...
#ifndef NAV2_SORTHAM_CONTROLLER__CRITIC_FUNCTION_HPP_
#define NAV2_SORTHAM_CONTROLLER__CRITIC_FUNCTION_HPP_
...
#include "nav2_sortham_controller/critic_data.hpp"

namespace sortham::critics
{

/**
 * @class sortham::critics::CollisionCost
...
/**
 * @class sortham::critics::CriticFunction
...
public:
  /**
    * @brief Constructor for sortham::critics::CriticFunction
    */
  CriticFunction() = default;

  /**
    * @brief Destructor for sortham::critics::CriticFunction
    */
...
#endif  // NAV2_SORTHAM_CONTROLLER__CRITIC_FUNCTION_HPP_
